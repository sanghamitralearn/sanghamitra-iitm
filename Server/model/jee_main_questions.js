...
const jeeMainQuestionSchema = new mongoose.Schema({
...
jeeMainQuestionSchema.index({ subject: 1 });
jeeMainQuestionSchema.index({ subject: 1, difficulty: 1 });

module.exports = mongoose.model('jee_main_question', jeeMainQuestionSchema, 'jee_main_questions');
