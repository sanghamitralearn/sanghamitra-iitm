...
// Lean response — no questionText/correctAnswer (already in jee_main_questions)
...
const jeeMainScoreSchema = new mongoose.Schema({
...
jeeMainScoreSchema.index({ email: 1, subject: 1 }, { unique: true });

module.exports = mongoose.model('jee_main_score', jeeMainScoreSchema, 'jee_main_scores');
