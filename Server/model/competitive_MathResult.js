...
const questionResultSchema = new mongoose.Schema({
  ...
  attempt_id: {
    ...
    ref: 'competitive_MathQuizAttempt',
    required: true,
    index: true
    },
  email: {
  ...
  question_id: {
    type: mongoose.Schema.Types.ObjectId,
    ref: 'competitive_math_questions',
    required: true,
    index: true
    },
...
// questionResultSchema.index({ email: 1, week: 1, subtopic: 1 });
module.exports = mongoose.model(
  'competitive_MathResult',
  questionResultSchema,
  'competitiveMath_results'
);