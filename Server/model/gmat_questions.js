...
const gmatQuestionSchema = new mongoose.Schema({
  question_number: Number,
  year: Number,
  paper: String,
  subject: {
    type: String,
    enum: ['Quantitative Reasoning', 'Verbal Reasoning', 'Data Insights'],
    required: true,
  },
  topic: String,
  subtopic: String,
...
gmatQuestionSchema.index({ subject: 1 });
gmatQuestionSchema.index({ subject: 1, difficulty: 1 });

module.exports = mongoose.model('gmat_question', gmatQuestionSchema, 'gmat_questions');
