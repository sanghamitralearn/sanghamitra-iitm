...
// ─── SAT Score Dashboard — shown right after a quiz / the full test is submitted ─
...
const SATScoreDashboard = ({
  results, sections = [], chapterItems = [],
  onRetake, saving, dateAttempted,
  heroTitle = 'Test Completed!', retakeLabel = 'Retake', backTo = '/courses/sat', backLabel = 'Back to SAT',
}) => {
  const tabs = sections.length > 1 ? ['Overview', 'Subjects', 'Chapters'] : ['Overview', 'Chapters']
                ...
                <div className="card border-0 shadow-sm h-100" style={{ borderRadius: 16, overflow: 'hidden' }}>
                  ...
                  <div className="card-body p-4">
                    <div className="d-flex justify-content-between align-items-center mb-3">
                      ...
                      <span className="badge text-white fs-6" style={{ background: style.gradient }}>{p}%</span>
                    </div>
...
export default SATScoreDashboard
