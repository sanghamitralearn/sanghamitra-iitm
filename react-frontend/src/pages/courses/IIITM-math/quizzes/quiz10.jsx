...
const Quiz10 = () => {
  ...
  const loadQuizData = () => {
    const sampleQuestions = [
      ...
      {
        id: 2,
        question: "What is the limit of sequence 1/n as n approaches infinity?",
        options: ["0", "1", "∞", "Does not exist"],
        correctAnswer: 0
      },
      {
        id: 3,
        question: "What is the limit of sequence (n+1)/n as n approaches infinity?",
        options: ["1", "0", "∞", "2"],
        correctAnswer: 0
      }
    ]
  ...
  const saveScore = async (correctAnswers, totalQuestions) => {
    try {
      await fetch('https://sanghamitra-learnworld.vercel.app/api/iitmmath_scores', {
        ...
        body: JSON.stringify({
          email: user.email, topic: 'Quiz10', score: correctAnswers,
    ...
    <main className="main">
      <section id="hero" className="hero section">
        ...
        <div className="container">
          <h2 data-aos="fade-up" data-aos-delay="100">IITM Math Quiz 10</h2>
          <p data-aos="fade-up" data-aos-delay="200">Sequence and limit (Week 7)</p>
