    ...
    const sampleQuestions = [
      {
        ...
        options: ["Function of a function", "Sum of functions", "Product of functions", "Inverse function"],
        correctAnswer: 0
      },
      {
        id: 2,
        question: "If f(x) = x² and g(x) = x + 1, what is f(g(x))?",
        options: ["(x + 1)²", "x² + 1", "x² + x + 1", "x + 1"],
        correctAnswer: 0
      },
      {
        id: 3,
        question: "What is the domain of composite function f(g(x))?",
        options: ["Values where g(x) is in domain of f", "All real numbers", "Only positive numbers", "Only integers"],
        correctAnswer: 0
      }
    ]
  ...
  const saveScore = async (correctAnswers, totalQuestions) => {
    try {
      await fetch('https://sanghamitra-learnworld.vercel.app/api/iitmmath_scores', {
        ...
        body: JSON.stringify({
          email: user.email, topic: 'Quiz16', score: correctAnswers,
    ...
    <main className="main">
      <section id="hero" className="hero section">
        ...
        <div className="container">
          <h2 data-aos="fade-up" data-aos-delay="100">IITM Math Quiz 16</h2>
          <p data-aos="fade-up" data-aos-delay="200">Composite Function (Quiz 16)</p>
