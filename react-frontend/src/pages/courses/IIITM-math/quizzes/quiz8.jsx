    ...
    const sampleQuestions = [
      {
        ...
        options: ["Function with variable in exponent", "Function with constant exponent", "Linear function", "Quadratic function"],
        correctAnswer: 0
      },
      {
        id: 2,
        question: "What is the base of exponential function f(x) = 2^x?",
        options: ["2", "x", "e", "10"],
        correctAnswer: 0
      },
      {
  ...
  const saveScore = async (correctAnswers, totalQuestions) => {
    try {
      await fetch('https://sanghamitra-learnworld.vercel.app/api/iitmmath_scores', {
        ...
        body: JSON.stringify({
          email: user.email, topic: 'Quiz8', score: correctAnswers,
    ...
    <main className="main">
      <section id="hero" className="hero section">
        ...
        <div className="container">
          <h2 data-aos="fade-up" data-aos-delay="100">IITM Math Quiz 8</h2>
          <p data-aos="fade-up" data-aos-delay="200">Exponential Functions (Week-5)</p>
