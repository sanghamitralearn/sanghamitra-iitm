    ...
    const sampleQuestions = [
      {
        ...
        options: ["Rate of change", "Y-intercept", "X-intercept", "Vertex"],
        correctAnswer: 0
      },
      {
        id: 2,
  ...
  const saveScore = async (correctAnswers, totalQuestions) => {
    try {
      await fetch('https://sanghamitra-learnworld.vercel.app/api/iitmmath_scores', {
        ...
        body: JSON.stringify({
          email: user.email, topic: 'Quiz5', score: correctAnswers,
    ...
    <main className="main">
      <section id="hero" className="hero section">
        ...
        <div className="container">
          <h2 data-aos="fade-up" data-aos-delay="100">IITM Math Quiz 5</h2>
          <p data-aos="fade-up" data-aos-delay="200">Linear function (Week 2)</p>
