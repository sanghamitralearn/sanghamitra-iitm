    ...
    const sampleQuestions = [
      {
        ...
        options: ["Expression with variables and coefficients", "Set of numbers", "Geometric shape", "Function type"],
        correctAnswer: 0
      },
      {
        id: 2,
        question: "What is the degree of polynomial x³ + 2x² + x + 1?",
        options: ["3", "2", "1", "4"],
        correctAnswer: 0
      },
      {
        id: 3,
        question: "What are the zeros of polynomial x² - 4?",
        options: ["2, -2", "4, -4", "1, -1", "0"],
        correctAnswer: 0
      }
    ]
  ...
  const saveScore = async (correctAnswers, totalQuestions) => {
    try {
      await fetch('https://sanghamitra-learnworld.vercel.app/api/iitmmath_scores', {
        ...
        body: JSON.stringify({
          email: user.email, topic: 'Quiz7', score: correctAnswers,
    ...
    <main className="main">
      <section id="hero" className="hero section">
        ...
        <div className="container">
          <h2 data-aos="fade-up" data-aos-delay="100">IITM Math Quiz 7</h2>
          <p data-aos="fade-up" data-aos-delay="200">Polynomials (Week 4)</p>
