...
const Quiz15 = () => {
  ...
  const loadQuizData = () => {
    const sampleQuestions = [
      {
        id: 1,
        question: "What are zeros of a polynomial?",
        options: ["Values where polynomial equals zero", "Highest degree term", "Constant term", "Leading coefficient"],
        correctAnswer: 0
      },
      {
        id: 2,
        question: "What is multiplicity of a zero?",
        options: ["How many times it appears as a root", "Value of the zero", "Degree of polynomial", "Number of terms"],
        correctAnswer: 0
      },
      {
        id: 3,
        question: "What is the zero of polynomial x - 3?",
        options: ["3", "-3", "0", "1"],
        correctAnswer: 0
      }
    ]
  ...
  const saveScore = async (correctAnswers, totalQuestions) => {
    try {
      await fetch('https://sanghamitra-learnworld.vercel.app/api/iitmmath_scores', {
        ...
        body: JSON.stringify({
          email: user.email, topic: 'Quiz15', score: correctAnswers,
    ...
    <main className="main">
      <section id="hero" className="hero section">
        ...
        <div className="container">
          <h2 data-aos="fade-up" data-aos-delay="100">IITM Math Quiz 15</h2>
          <p data-aos="fade-up" data-aos-delay="200">Polynomial - 1: Zeros and Multiplicity</p>
