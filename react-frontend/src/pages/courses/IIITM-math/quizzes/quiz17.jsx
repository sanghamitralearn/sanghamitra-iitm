    ...
    const sampleQuestions = [
      {
        ...
        options: ["Function that reverses another function", "Function with same output", "Function with no input", "Constant function"],
        correctAnswer: 0
      },
      {
        id: 2,
        question: "If f(x) = 2x, what is f⁻¹(x)?",
        options: ["x/2", "2/x", "x²", "2x"],
        correctAnswer: 0
      },
      {
        id: 3,
  ...
  const saveScore = async (correctAnswers, totalQuestions) => {
    try {
      await fetch('https://sanghamitra-learnworld.vercel.app/api/iitmmath_scores', {
        ...
        body: JSON.stringify({
          email: user.email, topic: 'Quiz17', score: correctAnswers,
    ...
    <main className="main">
      <section id="hero" className="hero section">
        ...
        <div className="container">
          <h2 data-aos="fade-up" data-aos-delay="100">IITM Math Quiz 17</h2>
          <p data-aos="fade-up" data-aos-delay="200">Inverse function</p>
