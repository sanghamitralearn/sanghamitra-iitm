    ...
    const sampleQuestions = [
      {
        ...
        options: ["Collection of elements", "Ordered pair", "Function", "Relation"],
        correctAnswer: 0
      },
      {
        id: 2,
        question: "What is the union of sets A={1,2} and B={2,3}?",
        options: ["{1,2,3}", "{1,3}", "{2}", "{1,2,2,3}"],
        correctAnswer: 0
      },
      {
        id: 3,
  ...
  const saveScore = async (correctAnswers, totalQuestions) => {
    try {
      await fetch('https://sanghamitra-learnworld.vercel.app/api/iitmmath_scores', {
        ...
        body: JSON.stringify({
          email: user.email, topic: 'Quiz6', score: correctAnswers,
    ...
    <main className="main">
      <section id="hero" className="hero section">
        ...
        <div className="container">
          <h2 data-aos="fade-up" data-aos-delay="100">IITM Math Quiz 6</h2>
          <p data-aos="fade-up" data-aos-delay="200">Sets and Relations (Week 1)</p>
