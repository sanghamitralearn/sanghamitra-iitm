...
const Quiz14 = () => {
  ...
  const loadQuizData = () => {
    const sampleQuestions = [
      {
        id: 1,
        question: "What are graph properties?",
        options: ["Characteristics of graphs", "Types of functions", "Algebraic equations", "Geometric shapes"],
        correctAnswer: 0
      },
      {
        id: 2,
        question: "What is a connected graph?",
        options: ["All vertices are connected", "No edges exist", "Only one vertex", "Disconnected components"],
        correctAnswer: 0
      },
      {
        id: 3,
        question: "What is a cycle in graph theory?",
        options: ["Closed path", "Straight line", "Disconnected graph", "Single vertex"],
        correctAnswer: 0
      }
    ]
  ...
  const saveScore = async (correctAnswers, totalQuestions) => {
    try {
      await fetch('https://sanghamitra-learnworld.vercel.app/api/iitmmath_scores', {
        ...
        body: JSON.stringify({
          email: user.email, topic: 'Quiz14', score: correctAnswers,
    ...
    <main className="main">
      <section id="hero" className="hero section">
        ...
        <div className="container">
          <h2 data-aos="fade-up" data-aos-delay="100">IITM Math Quiz 14</h2>
          <p data-aos="fade-up" data-aos-delay="200">Graph Properties (Week 11)</p>
