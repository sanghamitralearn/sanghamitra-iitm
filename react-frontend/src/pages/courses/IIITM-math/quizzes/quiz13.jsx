    ...
    const sampleQuestions = [
      {
        ...
        options: ["Set of vertices and edges", "Type of function", "Geometric shape", "Algebraic equation"],
        correctAnswer: 0
      },
      {
        id: 2,
        question: "What is a vertex in graph theory?",
        options: ["Point or node", "Line segment", "Curve", "Angle"],
        correctAnswer: 0
      },
      {
        id: 3,
        question: "What is an edge in graph theory?",
        options: ["Connection between vertices", "Type of vertex", "Graph property", "Graph function"],
        correctAnswer: 0
      }
    ]
  ...
  const saveScore = async (correctAnswers, totalQuestions) => {
    try {
      await fetch('https://sanghamitra-learnworld.vercel.app/api/iitmmath_scores', {
        ...
        body: JSON.stringify({
          email: user.email, topic: 'Quiz13', score: correctAnswers,
    ...
    <main className="main">
      <section id="hero" className="hero section">
        ...
        <div className="container">
          <h2 data-aos="fade-up" data-aos-delay="100">IITM Math Quiz 13</h2>
          <p data-aos="fade-up" data-aos-delay="200">Graph Theory (Week 10)</p>
