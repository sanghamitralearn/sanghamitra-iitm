    ...
    const sampleQuestions = [
      {
        ...
        options: ["Rate of change of a function", "Area under curve", "Slope of tangent line", "Both A and C"],
        correctAnswer: 3
      },
      {
        id: 2,
        question: "What is an integral?",
        options: ["Area under curve", "Rate of change", "Slope", "Limit"],
        correctAnswer: 0
      },
      {
        id: 3,
  ...
  const saveScore = async (correctAnswers, totalQuestions) => {
    try {
      await fetch('https://sanghamitra-learnworld.vercel.app/api/iitmmath_scores', {
        ...
        body: JSON.stringify({
          email: user.email, topic: 'Quiz12', score: correctAnswers,
    ...
    <main className="main">
      <section id="hero" className="hero section">
        ...
        <div className="container">
          <h2 data-aos="fade-up" data-aos-delay="100">IITM Math Quiz 12</h2>
          <p data-aos="fade-up" data-aos-delay="200">Derivatives and Integrals (Week 9)</p>
