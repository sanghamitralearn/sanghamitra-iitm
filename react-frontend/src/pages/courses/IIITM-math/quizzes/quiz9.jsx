    ...
    const sampleQuestions = [
      {
        ...
        options: ["Inverse of exponential function", "Type of polynomial", "Linear function", "Quadratic function"],
        correctAnswer: 0
      },
      {
        id: 2,
  ...
  const saveScore = async (correctAnswers, totalQuestions) => {
    try {
      await fetch('https://sanghamitra-learnworld.vercel.app/api/iitmmath_scores', {
        ...
        body: JSON.stringify({
          email: user.email, topic: 'Quiz9', score: correctAnswers,
    ...
    <main className="main">
      <section id="hero" className="hero section">
        ...
        <div className="container">
          <h2 data-aos="fade-up" data-aos-delay="100">IITM Math Quiz 9</h2>
          <p data-aos="fade-up" data-aos-delay="200">Logarithmic Functions (Week 6)</p>
