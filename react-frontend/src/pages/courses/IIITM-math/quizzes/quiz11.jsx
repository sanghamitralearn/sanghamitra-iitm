  ...
  const loadQuizData = () => {
    const sampleQuestions = [
      ...
      },
      {
        ...
        options: ["Finding the rate of change", "Finding the area under curve", "Finding the limit", "Finding the slope"],
        correctAnswer: 0
      },
      {
        id: 3,
  ...
  const saveScore = async (correctAnswers, totalQuestions) => {
    try {
      await fetch('https://sanghamitra-learnworld.vercel.app/api/iitmmath_scores', {
        ...
        body: JSON.stringify({
          email: user.email, topic: 'Quiz11', score: correctAnswers,
    ...
    <main className="main">
      <section id="hero" className="hero section">
        ...
        <div className="container">
          <h2 data-aos="fade-up" data-aos-delay="100">IITM Math Quiz 11</h2>
          <p data-aos="fade-up" data-aos-delay="200">Limits, Continuity and Differentiation (Week 8)</p>
