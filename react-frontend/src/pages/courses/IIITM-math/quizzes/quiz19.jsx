    ...
    const sampleQuestions = [
      {
        ...
        options: ["Ordered list of numbers", "Set of functions", "Type of equation", "Geometric shape"],
        correctAnswer: 0
      },
      {
        id: 2,
        question: "What is a limit in calculus?",
        options: ["Value a function approaches", "Exact value of function", "Function derivative", "Function integral"],
        correctAnswer: 0
      },
      {
        id: 3,
        question: "What is continuity in calculus?",
        options: ["Function has no breaks", "Function is differentiable", "Function has limits", "Function is linear"],
        correctAnswer: 0
      }
    ]
  ...
  const saveScore = async (correctAnswers, totalQuestions) => {
    try {
      await fetch('https://sanghamitra-learnworld.vercel.app/api/iitmmath_scores', {
        ...
        body: JSON.stringify({
          email: user.email, topic: 'Quiz19', score: correctAnswers,
    ...
    <main className="main">
      <section id="hero" className="hero section">
        ...
        <div className="container">
          <h2 data-aos="fade-up" data-aos-delay="100">IITM Math Quiz 19</h2>
          <p data-aos="fade-up" data-aos-delay="200">Sequence( week 7)</p>
