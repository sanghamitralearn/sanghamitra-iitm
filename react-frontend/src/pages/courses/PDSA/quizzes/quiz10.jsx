...
const Quiz10 = () => {
  ...
  const questions = [
    ...
    {
      id: 3,
      question: "What is the space complexity of the knapsack problem using dynamic programming?",
      options: [
        "O(n)",
        "O(W)",
        "O(n * W)",
    ...
    {
      id: 4,
      question: "Which data structure is used for implementing range minimum queries?",
      options: [
        "Segment Tree",
        "Binary Indexed Tree",
        "Sparse Table",
    ...
    {
      id: 5,
      question: "What is the time complexity of finding the closest pair of points using divide and conquer?",
      options: [
        "O(n)",
        "O(n log n)",
        "O(n²)",
          ...
          <div className="col-md-8">
            <div className="card">
              <div className="card-header">
                <h3 className="mb-0">PDSA Quiz 10: Advanced Problem Solving</h3>
              </div>
