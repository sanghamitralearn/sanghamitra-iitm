...
const Quiz18 = () => {
  ...
  const questions = [
    {
      id: 1,
      question: "What is the time complexity of finding the maximum flow using dynamic trees?",
      options: [
        "O(E * log V)",
        "O(V * E)",
        "O(V² * log V)",
    ...
    {
      id: 2,
      question: "Which algorithm is used for finding the minimum cost circulation with lower bounds?",
      options: [
    ...
    {
      id: 3,
      question: "What is the space complexity of the longest common subsequence problem with space optimization?",
      options: [
        "O(m + n)",
        "O(min(m, n))",
        "O(m * n)",
    ...
    {
      id: 4,
      question: "Which data structure is used for implementing a link-cut tree?",
      options: [
        "Array",
        "Tree",
        "Graph",
    ...
    {
      id: 5,
      question: "What is the time complexity of finding the maximum flow in a directed planar graph?",
      options: [
        "O(V log V)",
        "O(V log² V)",
        "O(V²)",
          ...
          <div className="col-md-8">
            <div className="card">
              <div className="card-header">
                <h3 className="mb-0">PDSA Quiz 18: Advanced Data Structures II</h3>
              </div>
