...
const Quiz1 = () => {
  ...
  // Sample quiz questions for PDSA Quiz 1
  const questions = [
    {
      id: 1,
    ...
    {
      id: 5,
      question: "In a max-heap, the largest element is stored at which position?",
      options: [
        "Root",
        "Left child",
        "Right child",
          ...
          <div className="col-md-8">
            <div className="card">
              <div className="card-header">
                <h3 className="mb-0">PDSA Quiz 1: Data Structures & Algorithms Fundamentals</h3>
              </div>
