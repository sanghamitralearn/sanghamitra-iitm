...
const Quiz8 = () => {
  ...
  const questions = [
    {
      id: 1,
      question: "What is the time complexity of finding the maximum flow using Ford-Fulkerson?",
      options: [
        "O(E * max_flow)",
        "O(V * E)",
        "O(V² * E)",
    ...
    {
      id: 5,
      question: "What is the time complexity of finding the shortest path in a DAG?",
      options: [
        "O(V + E)",
        "O(V log V)",
        "O(E log V)",
          ...
          <div className="col-md-8">
            <div className="card">
              <div className="card-header">
                <h3 className="mb-0">PDSA Quiz 8: Advanced Graph Algorithms</h3>
              </div>
