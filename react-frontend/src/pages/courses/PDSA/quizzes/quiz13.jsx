...
const Quiz13 = () => {
  ...
  const questions = [
    {
      id: 1,
      question: "What is the time complexity of finding the maximum flow using Dinic's algorithm?",
      options: [
        "O(V² * E)",
        "O(V * E²)",
        "O(V * E * log V)",
    ...
    {
      id: 2,
      question: "Which algorithm is used for finding the minimum cost maximum flow?",
      options: [
    ...
    {
      id: 3,
      question: "What is the space complexity of the traveling salesman problem using dynamic programming?",
      options: [
        "O(n * 2^n)",
        "O(n²)",
        "O(2^n)",
    ...
    {
      id: 4,
      question: "Which data structure is used for implementing a segment tree?",
      options: [
        "Array",
        "Tree",
        "Graph",
    ...
    {
      id: 5,
      question: "What is the time complexity of finding the maximum flow in a unit capacity network?",
      options: [
        "O(E * sqrt(V))",
        "O(V * E)",
        "O(V²)",
          ...
          <div className="col-md-8">
            <div className="card">
              <div className="card-header">
                <h3 className="mb-0">PDSA Quiz 13: Advanced Network Flow</h3>
              </div>
