...
const Quiz11 = () => {
  ...
  const questions = [
    {
      id: 1,
      question: "What is the time complexity of finding the maximum sum subarray using Kadane's algorithm?",
      options: [
        "O(n)",
        "O(n log n)",
        "O(n²)",
    ...
    {
      id: 3,
      question: "What is the space complexity of the edit distance problem using dynamic programming?",
      options: [
        "O(m + n)",
        "O(m * n)",
        "O(min(m, n))",
    ...
    {
      id: 4,
      question: "Which data structure is used for implementing a priority queue with O(1) decrease-key operation?",
      options: [
        "Binary Heap",
        "Fibonacci Heap",
        "Binomial Heap",
    ...
    {
      id: 5,
      question: "What is the time complexity of finding the maximum clique in a graph?",
      options: [
        "O(n)",
        "O(n log n)",
        "O(2^n)",
          ...
          <div className="col-md-8">
            <div className="card">
              <div className="card-header">
                <h3 className="mb-0">PDSA Quiz 11: Advanced Algorithms III</h3>
              </div>
