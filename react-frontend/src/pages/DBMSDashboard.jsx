...
const DBMSDashboard = () => {
  ...
  const load = async () => {
    ...
    try {
      ...
      setError('Failed to load DBMS data')
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="container my-4">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h2 className="mb-0">DBMS Dashboard</h2>
          <p className="text-muted mb-0">
            Database Management Systems assessments
          </p>
        </div>
                    ...
                    <tbody>
                      {students
                        .map(s => ({
                          ...
                          avgScore:
                            s.submissions.reduce((sum, sub) => sum + (sub.percentage || 0), 0) /
                        ...
                        .map((student, idx) => (
                          <tr key={idx}>
                            ...
                            <td
                              style={{
                                color: getScoreColor(student.bestScore),
                                fontWeight: 'bold'
                              }}
                            >
              ...
              <div className="modal-footer">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    alert('Scorecard data exported to console!')
                  }}
                >
          ...
          <div className="row mb-4">
            ...
            <div className="col-md-4 mb-3">
              <div className="card h-100 text-center">
                <div className="card-body">
                  <i
                    className="bi bi-file-text-fill text-warning"
                    style={{ fontSize: '2rem' }}
                  ></i>
                  ...
                  <table className="table table-hover">
                    ...
                    <tbody>
                      {students.map((student, i) => {
                        const sortedSubs = [...student.submissions].sort(
                          (a, b) => new Date(b.timestamp || 0) - new Date(a.timestamp || 0)
                        )

                        const recent = sortedSubs[0]
                          ...
                          >
                            ...
                            <td>
                              <span className="badge" style={{ background: typeInfo.color }}>
                                <i
                                  className={`bi ${typeInfo.icon} me-1`}
          ...
          >
            ...
            <div className="d-flex gap-2">
              <button
                ...
                onClick={() =>
                  navigate(`/admin/analysis/dbms/${selectedStudent.email}`, {
                    state: {
                      student: {
                        ...selectedStudent,
                        quizScores: selectedStudent.submissions.map(s => ({
                          topic: s.topic,
                          score: s.score,
                      ...
                      return (
                        <tr key={i}>
                          ...
                          <td>
                            {s.questionType ? (
                              <span className="badge bg-secondary">
                                {s.questionType === 'mcq-single'
                                  ? 'Single Select'
                                  : s.questionType === 'mcq-multiple'
                                    ? 'Multiple Select'
                                    : s.questionType === 'numerical'
                                      ? 'Numerical'
                                      : s.questionType}
                              </span>
                            ) : (
