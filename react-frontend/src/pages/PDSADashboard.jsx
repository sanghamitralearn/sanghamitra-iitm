      ...
      {!selectedStudent ? (
        ...
        <div className="card">
          <div className="card-header text-white d-flex justify-content-between align-items-center"
            ...
            <div className="d-flex gap-2">
              <button className="btn btn-warning btn-sm" onClick={() => navigate(`/admin/analysis/pdsa/${selectedStudent.email}`, { state: { student: { ...selectedStudent, quizScores: selectedStudent.submissions.map(s => ({ topic: s.topic, score: s.score, totalQuestions: s.maxScore, percentage: s.percentage || 0, timestamp: s.timestamp })) } } })}>
