...
async function loadStats2() {
  try {
    const result = await fetchFromAPI(`${VITE_API_URL}/api/iitm_stats2_quiz_attempt`)
    const activities = []
...
const subjectApis = [
  ...
  { key: 's2',        url: '/api/iitm_stats2_quiz_attempt',                 countFn: d => (Array.isArray(d) ? d : (d.data || [])).length },
